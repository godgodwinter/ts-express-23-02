...
const redis_studiv2_proses_service_1 = __importDefault(require("../studiv2/redis/redis.studiv2.proses.service"));
    ...
    constructor(req) {
        ...
        this.getAspekDetail = async (proses_id) => {
            try {
                ...
                const service = new redis_studiv2_proses_service_1.default(this.req);
        ...
        this.doMulai = async () => {
            try {
                ...
                if (cachedResult) {
                    ...
                    const saveAgain = await babengRedis_1.default.set(cacheKey, JSON.stringify(result), { EX: this.default_ex } // Set the specified expire time, in seconds. 86400=1HARI ,604800=7HARI
                    ); // 👈 updated code
                }
        ...
        this.doJawab = async () => {
            ...
            try {
                ...
                if (periksaJawaban === null || periksaJawaban === void 0 ? void 0 : periksaJawaban.skor) {
        ...
        // !ujianstudiv3
        this.periksaUjianAktif = async (proses_id) => {
            try {
                const service = new redis_studiv2_proses_service_1.default(this.req);
                // return this.params.siswa_id;
                ...
                for (const [index, data] of datas.entries()) {
                    ...
                    let getSisaWaktu = await (0, babengUjian_1.fn_get_sisa_waktu)(data.tgl_selesai);
        ...
        this.get_aspekdetail_tersedia = async (proses_id) => {
            try {
                const service = new redis_studiv2_proses_service_1.default(this.req);
                // return this.params.siswa_id;
                // ambil data dari redis
        ...
        this.getAspekDetail_detail = async (studi_v2_proses_aspek_detail_id) => {
            try {
                const service = new redis_studiv2_proses_service_1.default(this.req);
                // return this.params.siswa_id;
                // ambil data dari redis
        ...
        this.getSoal_perAspekdetail = async (studi_v2_proses_aspek_detail_id) => {
            try {
                const service = new redis_studiv2_proses_service_1.default(this.req);
                // return this.params.siswa_id;
                // ambil data dari redis
        ...
        this.getSoal_perSoal = async (studi_v2_proses_aspek_detail_id, studi_v2_proses_aspek_detail_soal_id) => {
            try {
                const service = new redis_studiv2_proses_service_1.default(this.req);
                // return this.params.siswa_id;
                // ambil data dari redis
        ...
        this.v3_doMulai = async (studi_v2_proses_aspek_detail_id) => {
            try {
        ...
        this.v3_doJawab = async (studi_v2_proses_aspek_detail_id, studi_v2_proses_aspek_detail_soal_id) => {
            // const delRedis = await redisClient.del(cacheKey);
            // const soal_index = this.body.soal_index;
            // const aspekdetail_index = this.body.aspekdetail_index;
            const service = new redis_studiv2_proses_service_1.default(this.req);
        ...
        this.v3_doFinish = async (studi_v2_proses_aspek_detail_id) => {
            try {
                const get_aspek_detail = await studi_v2_proses_aspek_detail.findOne({ where: { id: studi_v2_proses_aspek_detail_id, deleted_at: null } });
                get_aspek_detail.set({
                    tgl_selesai: moment().format(),
